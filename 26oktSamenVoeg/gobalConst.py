...
EVAL_FOLDER = 'run29oktRandomG99' # The folder that holds the model and train folders
...
rob_JointWidth = 10
rob_ResetAngles = np.radians(np.array([115,-95,115])) #np.radians(np.array([130,-140,140]))
...
netw_entCoef = 0.01 # Was at 0.1 originally, openAI has 0.01 as default in A2C
netw_maxGradNorm = 0.5 # was originally 40 and openAI has 0.5 in A2C


OUTP_FOLDER = '/localAlex30oktNachtRunMix1'
