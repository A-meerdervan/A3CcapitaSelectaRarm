...
# PARS USED ONLY IN MAIN
        ...
        self.OUTP_FOLDER = '/testVerwijder'
        self.NUM_WORKERS = 1 #multiprocessing.cpu_count() # Set workers ot number of available CPU threads
...
rc = RunConfig()
import mainA3C    # trick to make it run from this page
